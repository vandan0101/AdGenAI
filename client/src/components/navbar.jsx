        ...
        <>
            ...
            >
                <Link to="/" onClick={()=>scrollTo(0,0)}>
                    <img className="h-11 w-auto" src="/assets/logo.svg" width={138} height={36} alt="logo" />
                </Link>

                <div className="hidden lg:flex items-center gap-10 text-lg transition duration-500">
                    {navlinks.map((link) => (
                        <Link onClick={()=>scrollTo(0,0)}key={link.href} to={link.href} className="hover:text-slate-300 transition">
                            {link.text}
                        </Link>
                    ))}
                </div>
                            ...
                            {isSignedIn ? (
                                <>
                                    <UserButton 
                                        ...
                                        appearance={{
                                            elements: {
                                                avatarBox: "w-10 h-10 ring-2 ring-indigo-500/50 hover:ring-indigo-400 transition",
                                                userButtonPopoverCard: "bg-black/95 backdrop-blur-xl border border-white/10",
                                                userButtonPopoverActionButton: "hover:bg-white/10 text-slate-300",
                            ...
                            <>
                                <div className="flex justify-center">
                                    <UserButton 
                                        ...
                                        appearance={{
                                            elements: {
                                                avatarBox: "w-12 h-12 ring-2 ring-indigo-500/50",
                                            }
                                        }}
                                    >
                                        <UserButton.MenuItems>
                                            <UserButton.Action 
                                                label="My Generations" 
                                                labelIcon={<MenuIcon size={16} />}
                                                onClick={() => { navigate('/my-generations'); setIsMenuOpen(false); }}
                                            />
                                            <UserButton.Action 
                                                label="Community" 
                                                labelIcon={<MenuIcon size={16} />}
